...
# 載入全部 876 人名冊
ALL_EMPLOYEES = get_employee_dict()
    ...
    if not u["logged_in"]:
        ...
        if emp_id_input:
            if emp_id_input in ALL_EMPLOYEES:
                matched_info = ALL_EMPLOYEES[emp_id_input]
